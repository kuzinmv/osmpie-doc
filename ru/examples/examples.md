...
Здесь мы собираем различные примеры исправления перекрестков, простые и сложные, сломаные и совершенные.
...
| :---------------- | :------ | 
|![image info](./img/example-img7.png) | ![image info](./img/example-img8.png) |
