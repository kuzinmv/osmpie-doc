# junction:cluster:radius - тег для указания максимально возможного радиуса влияния/отношения пересечения на окружающие объекты
...
как-то иначе. В какой-то степени это понятие соотносится с понятием функциональной зоны перекрестка, только в данном случае - простейшего пересечения.

Главной мотивацией введения данного тега было обеспечить возможность группировки нод соседних пересечений в обобщающее
понятие **"Перекресток"**. Для этого у нас есть несколько различных вариантов, как это может быть сделано:
...
Плюсы и минусы первых двух подходов очевидны. Опять relation, ссылочная целостность, генерация тега.
...
* То есть принцип бритвы Оккама - не плодим новых сущностей без необходимости
...
На левой половине - ноды и вэйи, на правой половине - модель перекрестка, где радиус каждой ноды
отображен в виде гексагона. Все гексагоны объединены в группы по признаку наложения (union).
...
см. тег [junction:radius](./node.tags.junction:radius.md) - в каждый кластер входит 3-4 пересечения вэйев (автомобильных и пешеходных разных радиусов).
