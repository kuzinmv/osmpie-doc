# Руководство по OSMPIE. Порядок работы и формы ввода

## 1. Общий порядок работы с OSMPIE.
...
| `Default way's osmpie:fill value (veh,bus,psv) (m)` | Устанавливает новую точку каждые Х метров для дорог. См [глоссарий](./osmpie.tags.glossary.md#11-глоссарий-тегов-с-префиксом-osmpie) |
| `Default way's osmpie:fill value (tram,cycle) (m)` | Устанавливает новую точку каждые Х метров для трамваев и велосипедов. См [глоссарий](./osmpie.tags.glossary.md#11-глоссарий-тегов-с-префиксом-osmpie)  |
