...
| `Default way's osmpie:fill value (veh,bus,psv) (m)` | Устанавливает новую точку каждые Х метров для доро.г См [глоссарий](./osmpie.tags.glossary.md#11-глоссарий-тегов-с-префиксом) |
| `Default way's osmpie:fill value (tram,cycle) (m)` | Устанавливает новую точку каждые Х метров для трамваев и велосипедов. См [глоссарий](./osmpie.tags.glossary.md#11-глоссарий-тегов-с-префиксом)  |
